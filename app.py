...
def recommend(movie):
    ...
    return recommended_movies,recommened_movies_posters

movies_dict=pickle.load(open('Ref_base/movie.pkl','rb'))
movies=pd.DataFrame(movies_dict)

similarity=pickle.load(open('Ref_base/similarity.pkl','rb'))
